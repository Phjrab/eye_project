...
stop_by_pattern "eye_server.py" "python.*eye_server.py"
stop_by_pattern "server.py" "python.*[ /]server.py"
stop_by_pattern "epiphany browser" "epiphany|epiphany-browser|epiphany-browse"
